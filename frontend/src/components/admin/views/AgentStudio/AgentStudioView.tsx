    ...
    try {
      await fetchClient(`/agents/${botId}`, {
        ...
        body: JSON.stringify({
          ...
          aiTools: typeof bot.aiTools === "string" ? bot.aiTools : JSON.stringify(bot.aiTools || []),
          aiVisionModel: bot.aiVisionModel,
          aiFallbackModels: typeof bot.aiFallbackModels === "string" ? bot.aiFallbackModels : JSON.stringify(bot.aiFallbackModels || []),
    ...
    try {
      await fetchClient(`/agents/${botId}`, {
        ...
        body: JSON.stringify({
          ...
          aiTools: typeof updatedBot.aiTools === "string" ? updatedBot.aiTools : JSON.stringify(updatedBot.aiTools || []),
          aiVisionModel: updatedBot.aiVisionModel,
          aiFallbackModels: typeof updatedBot.aiFallbackModels === "string" ? updatedBot.aiFallbackModels : JSON.stringify(updatedBot.aiFallbackModels || []),
