...
async def check_login_allowed(email: str, ip: str) -> tuple[bool, str]:
    try:
        ...
        logger.warning(f"Redis unavailable for check_login_allowed: {e}")
        return True, ""
...
async def record_login_attempt(email: str, ip: str):
    try:
        ...
        logger.warning(f"Redis unavailable for record_login_attempt: {e}")
...
async def clear_login_attempts(email: str, ip: str):
    try:
        ...
        logger.warning(f"Redis unavailable for clear_login_attempts: {e}")
